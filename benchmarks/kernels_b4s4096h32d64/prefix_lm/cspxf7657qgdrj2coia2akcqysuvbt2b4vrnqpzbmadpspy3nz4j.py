...
# kernel path: /tmp/torchinductor_byou/6q/c6qq4tdhhj4boqcjqk4ps3ysto6lk474eelihqfr3t3dc3vjlsux.py
...
#   %where : [num_users=2] = call_function[target=torch.ops.aten.where.self](args = (%arg2_1, %full_default, %mul), kwargs = {})
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK0: tl.constexpr, xnumbl0: tl.constexpr, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    ...
    tmp15 = tl.full([XBLOCK0, 1], 0, tl.float32)
    # x6 = x6
    tmp23 = tl.full([XBLOCK0, 64], 0, tl.float32)
    ...
    for roffset in range(0, 4096, RBLOCK):
        ...
        tmp5 = tl.load(in_ptr2 + ((r7)[None, :] + (4096*x0)[:, None] + 16777216*x5), (r7 < 4096)[None, :] & (x0 < 4096)[:, None] & (x5 < 4), eviction_policy='evict_last', other=0.0).to(tl.int1)
        tmp21 = tl.load(in_ptr3 + ((x6)[None, :] + (64*r7)[:, None] + 262144*x4 + 8388608*x5), (x6 < 64)[None, :] & (r7 < 4096)[:, None] & (x4 < 32) & (x5 < 4), eviction_policy='evict_last', other=0.0)
        ...
        tmp18 = tmp15 * tmp17
        tmp15 = tmp18
        tmp19 = tmp15 + tl.sum(tmp14, 1)[:, None]
        tmp15 = tmp19
        tmp20 = tmp14.to(tl.bfloat16)
        tmp22 = tl.dot(tmp20, tmp21, input_precision='ieee')
        tmp24 = tmp23 * tmp17
        tmp23 = tmp24
        tmp25 = tmp23 + tmp22
        tmp23 = tmp25
...
def call(args):
    ...
    assert_size_stride(arg2_1, (4, 1, 4096, 4096), (16777216, 16777216, 4096, 1))
    assert_size_stride(arg3_1, (4, 32, 4096, 64), (8388608, 262144, 64, 1))
    with torch.cuda._DeviceGuard(0):
        ...
        triton_blo_fused__softmax_bmm_masked_fill_mul_0.run(buf4, arg0_1, arg1_1, arg2_1, arg3_1, 524288, grid=grid(524288), stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
        del arg3_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((4, 1, 4096, 4096), (16777216, 16777216, 4096, 1), device='cuda:0', dtype=torch.bool)
    arg3_1 = rand_strided((4, 32, 4096, 64), (8388608, 262144, 64, 1), device='cuda:0', dtype=torch.bfloat16)
