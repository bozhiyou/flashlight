...
# kernel path: /tmp/torchinductor_byou/2w/c2wxucgc4xm7hrpo6bpbtyeozlveho4duvuu4neywched7uqsa67.py
...
@triton_heuristics.template(
    num_stages=3,
    num_warps=4,
    triton_meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*i32', 5: '*i32', 6: '*i32', 7: '*i32', 8: '*bf16'}, 'device': DeviceProperties(type='cuda', index=0, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=108), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]},
    inductor_meta={'kernel_name': 'triton_tem_fused_0', 'backend_hash': 'A9C866B4A14FD3277824029365D703C2427B2E685E54EC9B3EF4ADC8D1EEAC1D', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
)
@triton.jit
def triton_(arg_Q, arg_K, arg_V, arg_LSE, arg_KV_NUM_BLKS, arg_KV_IDX, arg_FULL_KV_NUM_BLKS, arg_FULL_KV_IDX, out_ptr0):
    ...
    stride_qz, stride_qh, stride_qm, stride_qk = 8388608, 262144, 64, 1
    stride_kz, stride_kh, stride_kn, stride_kk = 8388608, 262144, 64, 1
    stride_vz, stride_vh, stride_vn, stride_vk = 8388608, 262144, 64, 1
    ...
    xindex = idx_d + (64*idx_m) + (262144*idx_hq) + (8388608*idx_z)
...
def forward_block_mn(
    ...
    return acc, l_i, m_i
''', device_str='cuda')
meta0 = {'ROWS_GUARANTEED_SAFE': False, 'PRESCALE_QK': False, 'OUTPUT_LOGSUMEXP': False, 'FLOAT32_PRECISION': "'ieee'", 'IS_DIVISIBLE': True, 'SM_SCALE': 0.125, 'GQA_SHARED_HEADS': 1, 'HAS_FULL_BLOCKS': True, 'QK_HEAD_DIM': 64, 'V_HEAD_DIM': 64, 'BLOCK_M': 128, 'BLOCK_N': 64, 'SPARSE_Q_BLOCK_SIZE': 128, 'SPARSE_KV_BLOCK_SIZE': 128}
...
def call(args):
    ...
    assert_size_stride(arg4_1, (4, 32, 32, 32), (32768, 1024, 32, 1))
    assert_size_stride(arg5_1, (4, 32, 32), (1024, 32, 1))
    assert_size_stride(arg6_1, (4, 32, 32, 32), (32768, 1024, 32, 1))
    assert_size_stride(arg7_1, (4, 32, 32), (1024, 32, 1))
    assert_size_stride(arg8_1, (4, 32, 32, 32), (32768, 1024, 32, 1))
    assert_size_stride(arg9_1, (4, 32, 32), (1024, 32, 1))
    assert_size_stride(arg10_1, (4, 32, 32, 32), (32768, 1024, 32, 1))
    buf0 = empty_strided_cuda((4, 32, 4096), (131072, 4096, 1), torch.float32)
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf1 = empty_strided_cuda((4, 32, 4096, 64), (8388608, 262144, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [flex_attention], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_tem_fused_0.run(arg0_1, arg1_1, arg2_1, buf0, arg3_1, arg4_1, arg5_1, arg6_1, buf1, grid=torch._inductor.kernel.flex_attention.flex_attention_grid(4, 32, 4096, 64, meta0), stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
        del arg3_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg3_1 = rand_strided((4, 32, 32), (1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg4_1 = rand_strided((4, 32, 32, 32), (32768, 1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg5_1 = rand_strided((4, 32, 32), (1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg6_1 = rand_strided((4, 32, 32, 32), (32768, 1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg7_1 = rand_strided((4, 32, 32), (1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg8_1 = rand_strided((4, 32, 32, 32), (32768, 1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg9_1 = rand_strided((4, 32, 32), (1024, 32, 1), device='cuda:0', dtype=torch.int32)
    arg10_1 = rand_strided((4, 32, 32, 32), (32768, 1024, 32, 1), device='cuda:0', dtype=torch.int32)
