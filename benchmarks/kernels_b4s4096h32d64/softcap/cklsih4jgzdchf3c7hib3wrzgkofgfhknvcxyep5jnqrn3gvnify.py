...
# kernel path: /tmp/torchinductor_byou/jn/cjnfg7qwcb5dazmndwoz7jcs6tdhgvfl77cnyep4d33lbvl64fhk.py
# Topologically Sorted Source Nodes: [matmul, attn_weight, truediv, tanh, attn_weight_1, attn_weight_2], Original ATen: [aten.bmm, aten.mul, aten.div, aten.tanh, aten._softmax]
# Source node to ATen node mapping:
#   attn_weight => mul
#   attn_weight_1 => mul_1
#   attn_weight_2 => amax, exp, sub, sum_1
#   matmul => bmm
#   tanh => tanh
#   truediv => div
# Graph fragment:
...
#   %div : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul, 30), kwargs = {})
#   %tanh : [num_users=1] = call_function[target=torch.ops.aten.tanh.default](args = (%div,), kwargs = {})
#   %mul_1 : [num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, 30), kwargs = {})
#   %amax : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%mul_1, [-1], True), kwargs = {})
#   %sub : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_1, %amax), kwargs = {})
...
triton_blo_fused__softmax_bmm_div_mul_tanh_0 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_blo_fused__softmax_bmm_div_mul_tanh_0.run(buf4, arg0_1, arg1_1, arg2_1, 524288, grid=grid(524288), stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
        del buf2
