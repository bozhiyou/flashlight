...
# kernel path: /tmp/torchinductor_byou/q7/cq7vnxcrlrlhvs7n4zidf6taflwdotkdbsogyczwtxatwmrfy4cs.py
...
# kernel path: /tmp/torchinductor_byou/v7/cv77ucso7icz2yombbrfow3tkkqx4uhleysip3fjw2gmyxomamat.py
...
# kernel path: /tmp/torchinductor_byou/gt/cgtaht5nourd3bmmovfjkkqe7fnovz7rhxd2w75fo2iinkfnqt32.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf6 = empty_strided_cuda((4, 32, 4096), (131072, 4096, 1), torch.float32)
        buf7 = empty_strided_cuda((0, ), (1, ), torch.float32)
        buf8 = empty_strided_cuda((0, ), (1, ), torch.float32)
        buf9 = empty_strided_cuda((4, 32, 4096, 64), (8388608, 262144, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [flex_attention], Original ATen: []
        triton_tem_fused_2.run(arg0_1, arg1_1, arg2_1, buf6, buf2, buf3, buf7, buf8, buf9, grid=torch._inductor.kernel.flex_attention.flex_attention_grid(4, 32, 4096, 64, meta0), stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
        del buf2
